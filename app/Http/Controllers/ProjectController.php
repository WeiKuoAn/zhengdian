...
class ProjectController extends Controller
{
    ...
    {
        return $this->dispatchNotification()->normalizeExecutorRows($executors);
    }
    ...
    protected function shouldSendDispatchWebhook(
        ...
        return $this->dispatchNotification()->shouldSend(
            $oldDate,
            $oldContent,
            $oldExecutors,
            $newDate,
    ...
    {
        return $this->dispatchNotification()->buildDispatchItemLabel($template);
    }
    ...
    public function plan_update(string $id, Request $request)
    {
        ...
        $dispatchNotification->resetSkipped();
        $previousPlanEnd = null;
        ...
        $redirect = redirect()->route('project.plan', $id)->with('success', '排程已儲存');
        $warning = $dispatchNotification->skippedWarningMessage();
        if ($warning !== null) {
