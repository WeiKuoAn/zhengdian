...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title', ['title' => '設定管理', 'subtitle' => '計畫狀態類別編輯'])
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" data-toggle="select" data-width="100%" name="parent_id">
                                        ...
                                        @foreach ($task_datas as $key => $task_data)
                                            <option value="{{ $task_data->id }}" @if($data->parent_id == $task_data->id) selected @endif>{{ $status_data->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-1">
