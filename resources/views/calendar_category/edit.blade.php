...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title', ['title' => '行事曆類別編輯', 'subtitle' => '設定管理'])

        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('CalendarCategory.edit.data',$data->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="classname" value="{{$data->classname}}" required>
                                </div>
                                <div class="mb-3">
