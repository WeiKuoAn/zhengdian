                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-bordered nav-justified">
                            <li class="nav-item">
                                <a href="{{ route('project.edit',$data->user_id)}}" aria-expanded="true" class="nav-link active">
                                    專案基本設定
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('project.write',$data->user_id) }}" aria-expanded="false" class="nav-link">
                                    內容撰寫
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" data-toggle="select" data-width="100%"
                                        ...
                                        @foreach ($check_statuss as $key => $check_status)
                                            <option value="{{ $check_status->id }}" @if($data->check_status == $check_status->id) selected @endif>{{ $check_status->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> <!-- end col-->
