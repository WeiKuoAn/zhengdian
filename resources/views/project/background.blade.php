                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-bordered nav-justified">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('project.background', $project->id) }}" aria-expanded="true" class="nav-link active">
                                    專案背景調查
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('project.accounting', $project->id) }}" aria-expanded="false" class="nav-link">
                                    經費報表
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="text-center">
                                            ...
                                            <h4 class="mt-3">專案背景資料儲存成功！</h4>
                                        </div>
                                    </div>
                                </div><!-- /.modal-content -->
                            </div><!-- /.modal-dialog -->
                        </div><!-- /.modal -->
                        <form action="{{ route('project.background.data',$project->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">'
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-4">
                                                        <label class="form-label" for="AddNew-Username"><b>公司負責人</b><span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control required-input"
                                                            name="principal_name" value="{{ $cust_data->principal_name }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-4">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="AddNew-Phone"><b>去年整年度營業額（單位：元/新台幣）</b><span
                                                                class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">公司登記地址<span
                                                                class="text-danger">*</span></label>
                                                        <div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">工廠登記地址<span
                                                                class="text-danger">*</span></label>
                                                        <div>
                                                            <div class="col-3 d-inline-block">
                                                                <select id="factory_county" name="factory_county"
                                                                    class="form-select col-4">
                                                                    <option value="">請選擇縣市</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <input type="hidden" id="factory_zipcode"
                                                                name="factory_zipcode">
                                                            <div class="col-4 d-inline-block">
                                                                <input type="text" class="form-control"
                                                                    name="factory_address" placeholder="輸入地址"
                                                                    value="{{ $cust_data->factory_address }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="AddNew-Phone"><b>近一年平均投保人數</b>（申請計畫使用）<span
                                                                class="text-danger">*</span></label>
                                                        <input type="number"
                                                            class="form-control required-input number-input"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-4">
                                                        <label class="form-label"
                                                            for="AddNew-Phone"><b>最近一期勞保投保人數</b>（申請計畫使用）<span
                                                                class="text-danger">*</span></label>
                                                        <input type="number"
                                                            class="form-control required-input number-input"
                                                            name="insurance_male" id="insurance_male"
                                                            placeholder="男生投保人數"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="number"
                                                            class="form-control required-input number-input"
                                                            name="insurance_female" id="insurance_female"
                                                            placeholder="女生投保人數"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-4">
                                                        <label class="form-label" for="AddNew-Phone"><b>&nbsp;</b></label>
                                                        <input type="number" class="form-control required-input"
                                                            placeholder="總投保人數" name="insurance_total"
                                                            id="insurance_total"
                                                ...
                                                <label class="form-label"
                                                    for="AddNew-Username"><b>公司主要聯繫窗口</b>（用於與計畫窗口對接）<span
                                                        class="text-danger">*</span></label>
                                                <div class="col-md-2">
                                                    <div class="mb-4">
                                                        <input type="text" class="form-control required-input"
                                                ...
                                                <div class="col-md-2">
                                                    <div class="mb-4">
                                                        <input type="text" class="form-control required-input"
                                                            name="main_contact_job" placeholder="職稱"
                                                ...
                                                <label class="form-label"
                                                    for="AddNew-Username"><b>提供一組全新的gmail帳號密碼</b><span
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        <input type="text" class="form-control required-input"
                                                            name="receive_email" placeholder="信箱"
                                                    ...
                                                    @if ($cust_data->subsidy == '1')
                                                        @if (count($cust_data->manufacture_subsidy_datas) > 0)
                                                            ...
                                                            <div class="form-group row mt-3">
                                                                <div class="col-12">
                                                                    <input id="add_customCheck1" class="btn btn-primary"
                                                                        type="button" name="" value="新增筆數">
                                                                </div>
                                                            </div>
                                                        @endif
                                                    @else
                                                        <div class="customCheck1_data row">
                                                            <div class="col-4">
                                                                <input type="text" class="form-control"
                                                                    name="subsidy_years[]" value=""
                                                                    placeholder="請提供年份">
                                                            </div>
                                                            <div class="col-4">
                                                                <input type="text" class="form-control"
                                                                    name="subsidy_names[]" value=""
                                                                    placeholder="請提供計畫名稱">
                                                            </div>
                                                            <div class="col-2">
                                                                <button class="mobile btn btn-danger del-row"
                                                ...
                                                <div class="row px-5" id="customCheck2_div">
                                                    ...
                                                    @else
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control"
                                                                name="avoid_department" value="" placeholder="單位">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control" name="avoid_job"
                                                                value="" placeholder="職稱">
                                                        </div>
                                                        <div class="col-md-2">
                                        ...
                                        <div class="col-12 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="text-center mb-3">
                                                        <h2>公司簡介</h2>
                                                        <p class="font-size-18">申請計畫使用<span class="text-danger">*</span>
                                                        </p>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="mb-4">
                                                                <label class="form-label"
                                                                    for="AddNew-Phone"><b>公司基本介紹</b><span
                                                                        class="text-danger">*</span></label>
...
@endif
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-4">
                                                                <label class="form-label"
                                                                    for="AddNew-Phone"><b>產品製程圖</b><span
                                                                        class="text-danger">*</span></label>
                                                                <div class="col-md-12 appendix">
                                                                    <div class="pl-5">
                                                                        <div class="alert alert-primary" role="alert">
                                                                            上傳網址： <a href="{{ $cust_data->nas_link }}"
                                                                                target="_blank"
                                                                                class="alert-link">請點擊我</a>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-4">
                                                                <label class="form-label"
                                                                    for="AddNew-Phone"><b>公司產品出口情形/比例</b><span
                                                                        class="text-danger">*</span></label>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label class="form-label"
                                                                        for="AddNew-Phone"><b>{{ $year }}年度</b><span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="hidden" class="form-control"
                                                                        name="three_years[]" value="{{ $year }}">
                                                                    <input type="number" class="form-control"
                                                                        name="three_incomes[]" value=""
                                                                        placeholder="{{ $year }}年">
                                                                </div>
                                                            @endif
                                                        @endforeach
                                                        ...
                                                        <hr class="mt-4 mb-4">
                                                        <label class="form-label"
                                                            for="AddNew-Username"><b>公司指標客戶（請列舉3-5家）</b><span
                                                                class="text-danger">*</span></label>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-12">
                                                                        <input id="add_customer" class="btn btn-primary"
                                                                            type="button" name="" value="新增筆數">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <input id="add_norm" class="btn btn-primary" type="button" name="" value="新增筆數">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-12">
                                                                            <input id="add_socail" class="btn btn-primary"
                                                                                type="button" name=""
                                                                                value="新增筆數">
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="checkIso_div px-5">
                                                            ...
                                                            @else
                                                                @for ($i = 0; $i < 1; $i++)
                                                                    <div class="row  mt-2">
                                                                        <div class="col-md-2">
                                                                            <input type="text" class="form-control"
                                                                                name="iso_names[]" value=""
                                                                                placeholder="ISO名稱">
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <input type="text" class="form-control"
                                                                                name="iso_years[]" value=""
                                                                                placeholder="年份">
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <select class="form-select"
                                                            ...
                                                            <div class="form-group row mt-3">
                                                                <div class="col-12">
                                                                    <input id="add_iso" class="btn btn-primary"
                                                                        type="button" name="" value="新增筆數">
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row mt-4 mb-2">
                                                <div class="col text-center">
                                                    <button type="button" class="btn btn-danger me-1"
                                                        onclick="history.go(-1)"><i class="bx bx-x me-1"></i>
                                                        回上一頁</button>
