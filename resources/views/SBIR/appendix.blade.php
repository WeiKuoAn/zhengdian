                                                                        ...
                                                                        <div class="form-check font-size-16">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                ...
                                                                                <h5 class="font-size-16 m-0">
                                                                                    1.最近一年之年度損益及稅額計算表<span
                                                                                        class="text-danger">（請每頁加蓋公司大章及負責人小章）</span>
                                                                                </h5>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 40px;">
                                                                        <div class="form-check font-size-16">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="sbir_appendix07">
                                                                                <h5 class="font-size-16 m-0">7.計畫申請表<span
                                                                                        class="text-danger">（請用印公司大章及負責人小章）</span>
                                                                                </h5>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td style="width: 40px;">
                                                                        <div class="form-check font-size-16">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="sbir_appendix10">
                                                                                <h5 class="font-size-16 m-0">
                                                                                    10.曾執行政府計畫揭露聲明書正本 1 份<span
                                                                                        class="text-danger">（請用印公司大章及負責人小章＋填日期）</span>
                                                                                </h5>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 40px;">
                                                                        <div class="form-check font-size-16">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="sbir_appendix12">
                                                                                <h5 class="font-size-16 m-0">12.合作意向書<span
                                                                                        class="text-danger">（請用印雙方公司大章及負責人小章）</span>
                                                                                </h5>
                                                                            </label>
                                                                        </div>
                                                                    </td>
