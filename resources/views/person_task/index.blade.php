                ...
                <div class="row justify-content-between">
                    <div class="col-md-10">
                        <form class="d-flex flex-wrap align-items-center" action="{{ route('person.task') }}" method="GET">
                            ...
                            <div class="me-3">
                                <input type="date" name="startDate" id="start_date" class="form-control my-1 my-md-0" value="{{ request()->get('start_date') }}">
                            </div>
                            <div class="me-3">
                                <input type="date" name="endDate" id="end_date" class="form-control my-1 my-md-0" value="{{ request()->get('end_date') }}">
                            </div>
                                ...
                                <div class="modal-body">
                                    <form id="taskForm">
                                        ...
                                        <button type="button" class="btn btn-primary"
                                            onclick="updateTaskStatus()">保存</button>
                                    </form>
                                </div>
                            </div>
                        </div>
