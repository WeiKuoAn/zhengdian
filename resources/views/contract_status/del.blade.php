@extends('layouts.vertical', ['title' => '專案狀態刪除'])

@section('content')
    <!-- Start Content-->
    <div class="container-fluid">

        @include('layouts.shared.page-title', ['title' => '專案狀態刪除', 'subtitle' => '設定管理'])

        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('contractStatus.del.data',$data->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="mb-3">
