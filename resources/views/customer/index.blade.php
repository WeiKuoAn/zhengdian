@extends('layouts.vertical', ['title' => '客戶列表'])
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                            href="{{ route('customer.edit.data', $data->user_id) }}"><i
                                                                class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i>帳號設定</a>
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('user.introduce.edit', $data->user_id) }}"><i
                                                                class="mdi mdi-clipboard-text-search me-2 font-18 text-muted vertical-middle"></i>公司基本資料</a>
